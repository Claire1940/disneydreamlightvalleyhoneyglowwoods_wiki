...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Terms of Service - Honeyglow Woods Wiki',
    description: 'Read the Terms of Service for Honeyglow Woods Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Disney Dreamlight Valley: Honeyglow Woods fan resource platform.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Terms of Service - Honeyglow Woods Wiki',
      description: 'Terms and conditions for using Honeyglow Woods Wiki.',
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Honeyglow Woods Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Honeyglow Woods Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Honeyglow Woods Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Honeyglow Woods Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Disney Dreamlight Valley: Honeyglow Woods Adventure Pack. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Quest walkthroughs and character friendship guides</li>
              <li>Beekeeping and Golden Honey mechanics</li>
              <li>New area and Everoak Tree exploration guides</li>
              <li>Pooh Sticks and minigame tips</li>
              <li>Recipe, crafting, and reward information</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Honeyglow Woods Wiki is NOT affiliated with, endorsed by, or associated with
              The Walt Disney Company, Gameloft SE, or the official developers of Disney Dreamlight Valley: Honeyglow Woods.
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Honeyglow Woods Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of The Walt Disney Company and/or Gameloft SE. We use such
            ...
            <ul>
              ...
              <li><strong>Game Changes:</strong> Pricing, release dates, platform availability, and game content may change without notice. We are not responsible for game changes or DLC availability.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, HONEYGLOW WOODS WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Steam, the Nintendo, PlayStation, and Xbox
              storefronts, the official Disney Dreamlight Valley website, Discord, social media platforms,
            ...
            <p>
              ...
              you and Honeyglow Woods Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@disneydreamlightvalleyhoneyglowwoods.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@disneydreamlightvalleyhoneyglowwoods.wiki</a>
            </p>
            <p>
